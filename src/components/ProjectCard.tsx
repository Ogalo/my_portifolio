    ...
    >
      ...
      >
        ...
        <Stack mt={2.5}>
          ...
          Boma is an online marketplace offering a platform for free classified ads. It allows users to buy and sell a wide range of products and services, including vehicles, real estate, electronics, furniture, and more. The site will also features job listings and services like repair and construction. It's a comprehensive platform catering to various needs, making it a go-to site for classifieds in the world.
          </Typography>
        </Stack>
        <Stack my={2}>
          <GitHubIcon />
