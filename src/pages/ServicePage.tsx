...
const Services = () => {
  return (
    <Box px={5} sx={{ backgroundColor: "#111835", height: '100%', overflow: 'hidden'}} >
      <Typography variant="h4" fontFamily="karma" pt={5} color="white">
        Services
      </Typography>
      ...
      <Box display='flex' gap={6} flexDirection='row' flexWrap='wrap' mt={3} justifyContent='space-evenly'>
        ...
        sx={{
          ...
          <Typography variant='h5' fontFamily='karma' pt={2} color="#83C4D2" > UI/UX  Design</Typography>
          <Typography variant='h6' fontFamily='karma' my={1} color="white">
        ...
        sx={{
          ...
          <Typography variant='h5' fontFamily='karma' pt={2} color="#83C4D2"> Web Development</Typography>
          <Typography variant='h6' fontFamily='karma' my={1} color="white">
        ...
        sx={{
          ...
          <Typography variant='h5' fontFamily='karma' pt={2} color="#83C4D2"> Mobile App</Typography>
          <Typography variant='h6' fontFamily='karma' my={1} color="white">
        ...
        sx={{
          ...
          <Typography variant='h5' fontFamily='karma' pt={2} color="#83C4D2"> Content Writing</Typography>
          <Typography variant='h6' fontFamily='karma' my={1} color="white">
        ...
        sx={{
          ...
          <Typography variant='h5' fontFamily='karma' pt={2} color="#83C4D2"> Video Editing</Typography>
          <Typography variant='h6' fontFamily='karma' my={1} color="white">
        ...
        sx={{
          ...
          <Typography variant='h5' fontFamily='karma' pt={2} color="#83C4D2"> Mentorship</Typography>
          <Typography variant='h6' fontFamily='karma' my={1} color="white">
